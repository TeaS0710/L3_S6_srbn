...
#Charger le modèle spaCy adapté à la langue
#Si non supportée, utiliser le modèle multilingue xx_sent_ud_sm
...
#Appliquer la tokenisation, filtrage linguistique, NER et lemmatisation à un corpus multilingue.
#Retourner à {langue: [ {tokens, labels, lemmes} ]}
